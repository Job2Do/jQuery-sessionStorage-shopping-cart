	...
	$.Shop.prototype = {
			...
			if( this.$formCart.length ) {
				...
				if( items.length == 0 ) {
					...
					for( var i = 0; i < items.length; ++i ) {
						...
						var qty = item.qty;
						var html = "<tr><td><img src=\”” + product.image + “\”></td><td class='pname'>" + product + "</td>" + "<td class='pqty'><input type='text' value='" + qty + "' class='qty'/></td>";
				...
				if( cartItems.length > 0 ) {
					...
					for( var j = 0; j < cartItems.length; ++j ) {
						...
						var cartHTML = "<tr><td><img src=\”” + cartProduct.image + “\”></td><td class='pname'>" + cartProduct + "</td>" + "<td class='pqty'>" + cartQty + "</td>" + "<td class='pprice'>" + cartPrice + "</td></tr>";
		...
		handleAddToCartForm: function() {
			...
			self.$formAddToCart.each(function() {
				...
				var image = $product.prev().find( "img" ).attr( "src" );
